...
function Header() {
    ...
    return (
        <header className="sticky top-0 bg-white">
            ...
            <Image onClick={()=>router.push("/")} className="cursor-pointer"  src='https://www.google.co.uk/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png' alt="" height={40} width={120} /> 
        ...
        <Avatar className="ml-auto" url='/1.png' />
            </div>
      <HeaderOptions />
        </header>
    )
